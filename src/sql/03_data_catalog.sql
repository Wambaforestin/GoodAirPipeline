...
VALUES
    ...
    ('Gold', 'FactMesures', 'PM25', 'DECIMAL(6,2)', 'AQICN', 'data.iaqi.pm25.v', N'Particules fines PM2.5', 1),
    ('Gold', 'FactMesures', 'PM10', 'DECIMAL(6,2)', 'AQICN', 'data.iaqi.pm10.v', N'Particules PM10', 1),
    ('Gold', 'FactMesures', 'NO2', 'DECIMAL(6,2)', 'AQICN', 'data.iaqi.no2.v', N'Dioxyde d''azote', 1),
    ('Gold', 'FactMesures', 'O3', 'DECIMAL(6,2)', 'AQICN', 'data.iaqi.o3.v', N'Ozone troposphérique', 1),
