...
> **Note importante :** Les colonnes PM25, PM10, NO2, O3 contiennent des indices AQI (échelle 0-500) renvoyés par l'API AQICN, pas des concentrations en µg/m³. Les seuils OMS dans `Ref.SeuilsOMS` sont exprimés en µg/m³. Une comparaison directe entre ces valeurs nécessite une conversion AQI → µg/m³.
